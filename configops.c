...
Dependencies: compareString copyString, fclose, fopen, fscanf,
              getCpuSchedCode, getDataLineCode, getLogToDoce,
              getStringToDelimiter, malloc, setStrToLowerCase,
              stripTrailingSpaces, valueInRange
*/
            ...
            // get data value
              ...
              // CPU Scheduling names, or memory display setting (strings)
                                ...
                                || dataLineCode == CFG_MEM_DISPLAY_CODE )
                 {
                  ...
                  // set string to lower case for testing value in range
        ...
        if( valueInRange( dataLineCode, intData, doubleData, 
                                                        lowerCaseDataBuffer ) )
           {
            ...
            // (all config line possibilities)
              ...
              //           compareString, getLogToDoce, as needed
            switch( dataLineCode )
               {
...
Process: converts cpu schedule string code (all scheduling possibilites
