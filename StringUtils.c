 ...
 */
 ...
 Function Output/Parameters: c-stylke destination string (char *)
 ...
 */
 ...
 /*
 Name: copyString
 Process: copies on string into another,
 ...
 bool getStringConstrained(
    ...
    if( intChar == EOF )
     ...
     while( 
          ...
          // AND
          // continues if specified delimiter is not
...
/*
 ...
 Process: captures a string from the input stream
          ...
          Note: consumes delimiter
 Function Input/Parameters: input stream (FILE *)
                            stops at specfified delimiter (char),
 Function Output/Parameters: string returned (char *) 
 Function Output/Returned: success of operation (bool) 
 Device Input/Keyboard: none
 Device Output/Monitor: none 
 ...
 bool getStringToDelimiter(
                          ...
                          )
    {
     ...
     return getStringConstrained(
                    ...
                    delimiter,            // non printable delimiter 
 ...
 */
 ...
 /*
 Name: getSubString
 Process: captrues sub string within larger string 
          between two inclusive indices
          returns empoty string if either index is out of range,
                         ...
                         int startIndex, int endIndex )
    {
     ...
     if( startIndex >= 0 && startIndex <= endIndex 
        ...
        { 
         ...
         // loop across reequested substring (indices)
